...
namespace cockpit
{
	namespace Samples
	{
		...
		private:
			...
			static void hud_radar_alt(Element* elem, ccDrawable* parent, const DParamList& args);
			static void hud_velocity_vector(Element* elem, ccDrawable* parent, const DParamList& args);
			//static void hud_gun_sight_funnel(Element* elem, ccDrawable* parent, const DParamList& args);
		};
	}
}
