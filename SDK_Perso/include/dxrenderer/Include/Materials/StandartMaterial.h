#ifndef _LOCKON_STANDART_MATERIAL_H_
#define _LOCKON_STANDART_MATERIAL_H_
...
class StandartMaterial: public MaterialBase {
protected:
...
public:
	...
	DXRENDERER_API StandartMaterial();
	DXRENDERER_API StandartMaterial(const StandartMaterial&);

	DXRENDERER_API virtual ~StandartMaterial();
