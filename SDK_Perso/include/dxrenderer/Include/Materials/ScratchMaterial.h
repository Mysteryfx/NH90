#ifndef _LOCKON_SCRATCH_MATERIAL_H_
#define _LOCKON_SCRATCH_MATERIAL_H_
...
class ScratchMaterial: public MaterialBase {
protected:
...
public:
	...
	DXRENDERER_API ScratchMaterial();
	DXRENDERER_API ScratchMaterial(const ScratchMaterial&);

	DXRENDERER_API virtual ~ScratchMaterial();
