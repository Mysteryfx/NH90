...
protected:
	...
	virtual double		get_max_available_distance() const;
	virtual float 		get_max_clutter_distance() const; 
	...
	virtual void		update_acquisition();
	virtual void		update_STT();
	virtual bool		update_STT_data();
	virtual void        mail_lock(woPointer ptr);
	void				update_export();
	...
	double get_width_of_scan_beam() const;
	...
	bool							    use_nearest_target_for_acquisition;
	virtual void		next_scan_step();
	void				next_scan_line();
...
//
	...
	limits_d					tracking_azimuth;
	limits_d					tracking_elevation;

	limits_d					roll_compensation_limits;
	limits_d					pitch_compensation_limits;
