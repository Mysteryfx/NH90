...
{
public:
    cLaserRanger():m_maxRange(9999.0),m_range(0.0), m_isEnabled(true), m_isOn(false) {};
    cLaserRanger(double maxValue, bool isEnabled_, bool isOn):m_maxRange(maxValue),m_range(0.0),m_isEnabled(isEnabled_),m_isOn(isOn) {};
